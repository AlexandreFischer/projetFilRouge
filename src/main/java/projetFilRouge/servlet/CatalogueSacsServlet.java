 ...
 * @author alexa
 */
@WebServlet(name = "ListeDeTousLesArticlesSacs", urlPatterns = {"/catalogueSacs"})
public class CatalogueSacsServlet extends AutowireServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        // Appel service
        req.setAttribute("articles", service.afficherArticleParCategorieSac());
