	              ...
	              <th>Delete</th>
	                            ...
	                            <tbody>
	                              <tr>
	                                ...
	                                <td>Jeans Levis</td>
	                                <td>23</td>
	                                <td> Bonjour, bien reÃ§u mais la taille est un peu juste</td>
<td><p data-placement="top" data-toggle="tooltip" title="Edit">
	                              ...
	                              <tr>
	                                <td><input type="checkbox" class="checkthis" /></td>
	                                <td>00016</td>
	                                <td>Robe bleue femme</td>
	                                <td>12</td>
	                                <td> La couleur de la robe reÃ§ue n'est pas du tout bleue mais verte</td>
<td><p data-placement="top" data-toggle="tooltip" title="Edit">
	                                  <button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></button>
	                                  </p></td>
	                                <td><p data-placement="top" data-toggle="tooltip" title="Delete">
	                              ...
	                              <tr>
	                                ...
	                                <td>152</td>
	                                <td>Chaussures trÃ¨s confortables. je recommande !</td>
<td><p data-placement="top" data-toggle="tooltip" title="Edit">
	                                  <button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></button>
	                                  </p></td>
	                                <td><p data-placement="top" data-toggle="tooltip" title="Delete">
	                              ...
	                              <tr>
	                                <td><input type="checkbox" class="checkthis" /></td>
	                                <td>05002</td>
	                                <td>Sac ville cuir</td>
	                                <td>93</td>
	                                <td>Sac trÃ¨s jolie mais la sangle est dÃ©jÃ  cassÃ©e aprÃ¨s deux semaines...</td>
<td><p data-placement="top" data-toggle="tooltip" title="Edit">
	                                  <button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></button>
	                                  </p></td>
	                                <td><p data-placement="top" data-toggle="tooltip" title="Delete">
	                              ...
	                              <tr>
	                                ...
	                                <td>Echarpe soie</td>
	                                <td>37</td>
	                                <td> Echarpe trÃ¨s chaude ! N'hÃ©sitez pas si vous Ãªtes frileux ;-)</td>
<td><p data-placement="top" data-toggle="tooltip" title="Edit">
	                                  <button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></button>
	                                  </p></td>
	                                <td><p data-placement="top" data-toggle="tooltip" title="Delete">
