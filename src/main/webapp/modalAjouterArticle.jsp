...
<div class="modal fade" id="modalAjouterArticle" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <form role="form" method="POST" action="ajoutArticleVendeur">
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="nom" id="nom" placeholder="Nom de l'article" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="description" id="description" placeholder="Décrivez votre article" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-envelope fa" aria-hidden="true"></i></span>
                                <input type="text" class="form-control" name="prixHT" id="prixHT" placeholder="Prix HT ex 19.90" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                                <input type="text" class="form-control" name="delaisAppros" id="delaisAppros" placeholder="Quel délais d'approvisionnement ?"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group"> <span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                                <input type="text" class="form-control" name="delaisDeLivraisonArt" id="delaisDeLivraisonArt" placeholder="Quel délais de livraison ?" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group"> <span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                                <input type="text" class="form-control" name="quantiteStock" id="quantiteStock" placeholder="Quel quantité en stock ?" />
                            </div>
                        </div>
                    </div>
